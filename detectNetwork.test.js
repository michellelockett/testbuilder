...
describe('Discover', function() {
  ...
  var expect = chai.expect;
  var suffix16 = '1234567890123';
  var suffix19 = '1234567890123456';
  ...
  for (var prefix = 644; prefix <= 649; prefix++) {
      (function(prefix) {
        it('has a prefix of ' + prefix + ' and a length of 16', function() {
          expect(detectNetwork(prefix.toString() + suffix16)).to.equal('Discover');
        });

        it('has a prefix of ' + prefix + ' and a length of 19', function() {
          expect(detectNetwork(prefix.toString() + suffix19)).to.equal('Discover');
        });
      })(prefix)
  }
  ...
  it('has a prefix of 65 and a length of 19', function() {
    expect(detectNetwork('6512341234123412341')).to.equal('Discover');
  });
});
